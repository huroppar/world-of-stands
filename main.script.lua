...
if not allowedUsers[LocalPlayer.Name] then
    local inputKey = tostring(game:HttpGet("https://pastebin.com/raw/NCWZ9uxk")) -- ここをGUI入力に差し替えてもOK
    if inputKey ~= "Masashi0407" then
        game.Players.LocalPlayer:Kick("認証失敗！キーが正しくありません。")
        return
    end
end
